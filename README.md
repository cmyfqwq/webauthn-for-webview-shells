...
[English](#-what-this-actually-is) · [中文](#-这到底是什么)
...
| 菊花浏览器 (`com.jiaohua_browser`) | wired (needs manual test) |
| QEdge (`me.lengyu.qedge`) | needs manual test |
| Others | open `src/.../MainHook.java`, add the package name, rebuild |
